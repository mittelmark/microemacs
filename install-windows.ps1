...
function Install-Me ($me) {
    ...
    $zipUrl = "https://github.com/mittelmark/microemacs/releases/download/v09.12.26.beta2/windows-10-intel-microemacs-091226b2-"+$me+".zip"
    $fileToExtract = "windows-10-intel-microemacs-091226b2-"+$me+"/bin/"+$me+".exe"
